...
public class Functionalities {
    ...
    public boolean hasPath(String stationNm1, String stationNm2, HashMap<String, Boolean> processed) 
        ...
        HashMap<String,DijkstrasPair> map = new HashMap<>(); //to store Dijkstra's Pair object for each vertex

        PriorityQueue<DijkstrasPair> pq = new PriorityQueue<DijkstrasPair>((x,y)-> x.cost - y.cost); //arranging Dijkstra's Pair objects according to the cost where minimum cost is given priority.
