                    ...
                    case 1:
                        ...
                        Thread passwordThread = new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                password[0] = new String(passwordArray);
                            }
                        });
                        ...
                        try {
                            // Wait for the password thread to complete
                            passwordThread.join();
                        } catch (InterruptedException e) {
                            e.printStackTrace();
                        }

                        if (password[0].equals(adminPassword)) {
                            showAdminPanel();
                        } else {
            ...
            try {
                ...
                switch (option) {
                    ...
                    case 4:
                        ...
                        System.out.print(srcStation + " ---> "+desStation + " (approximately) = " + res+ " km\n\n");
                        System.out.println("\n================================================================================\n");
                        break;
                    case 5:
                    System.out.println("\n================================================================================\n");
